    ...
    <ScreenContainer style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerRow}>
          <Avatar name={userName} uri={currentUser?.profilePhoto} size={50} />
          ...
          <View style={styles.headerRight}>
            ...
            <Avatar name={userName} uri={currentUser?.profilePhoto} size={38} />
          </View>
        </View>

        {/* 2x2 Grid Statistic Cards */}
          ...
          <View style={styles.gridRow}>
            ...
            <View style={[styles.statCard, { backgroundColor: '#f0f9ff', borderColor: '#e0f2fe' }]}>
              <View style={styles.cardHeader}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                  ...
                  <Text style={[styles.cardTitle, { color: '#0369a1' }]}>Pickups{"\n"}Today</Text>
                </View>
              </View>
            ...
            <View style={[styles.statCard, { backgroundColor: '#fff7ed', borderColor: '#ffedd5' }]}>
              <View style={styles.cardHeader}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                  <Text style={{ fontSize: 22 }}>🚚</Text>
                  <Text style={[styles.cardTitle, { color: '#c2410c' }]}>Deliveries{"\n"}Today</Text>
                </View>
              </View>
          ...
          <View style={styles.gridRow}>
            ...
            <View style={[styles.statCard, { backgroundColor: '#f0fdf4', borderColor: '#dcfce7' }]}>
              <View style={styles.cardHeader}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                  ...
                  <Text style={[styles.cardTitle, { color: '#15803d' }]}>Drops{"\n"}Completed</Text>
                </View>
              </View>
            ...
            <View style={[styles.statCard, { backgroundColor: '#fefce8', borderColor: '#fef3c7' }]}>
              <View style={styles.cardHeader}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                  <Text style={{ fontSize: 22 }}>💵</Text>
                  <Text style={[styles.cardTitle, { color: '#a16207' }]}>Total{"\n"}Earnings</Text>
                </View>
              </View>
              ...
              <Text style={[styles.cardSubtitle, { color: '#ca8a04', marginTop: 8 }]}>Commission{"\n"}Earned Today</Text>
            </View>
          </View>
        </View>
